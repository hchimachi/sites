<?php
	...
	class WS_Form_API_Helper extends WS_Form_API {
		...
		public function api_ws_form_css() {
			...
			// Output CSS
			$ws_form_css = new WS_Form_CSS();
			echo $ws_form_css->get_layout(null, false, is_rtl());	// phpcs:ignore
		...
		public function api_ws_form_css_skin() {
			...
			// Output CSS
			$ws_form_css = new WS_Form_CSS();
			echo $ws_form_css->get_skin(null, false, is_rtl());	// phpcs:ignore
		...
		public function api_ws_form_css_conversational() {
			...
			// Output CSS
			$ws_form_css = new WS_Form_CSS();
			echo $ws_form_css->get_conversational(null, false, is_rtl());	// phpcs:ignore
