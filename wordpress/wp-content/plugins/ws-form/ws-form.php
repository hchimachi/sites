<?php
	...
	if(!is_plugin_active('ws-form-pro/ws-form.php')) {
		...
		define('WS_FORM_FIELD_INVALID_FEEDBACK', __('Please provide a valid #label_lowercase.', 'ws-form'));
		...
		define('WS_FORM_MIN_VERSION_WORDPRESS', '5.0');
