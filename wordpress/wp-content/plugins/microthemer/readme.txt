...
# Bugs fixed
* Reverted the fix in 6.3.6.8 as it caused issues for some users.

= 6.3.6.9 (June 6th, 2021) =

# Bugs fixed
* False positive warning in editor when a :not() selector contained spaces.

= 6.3.6.8 (May 20th, 2021) =
