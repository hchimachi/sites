...
<div style="position: relative;display: inline-block;">
    ...
    <div style="position: absolute;top:0;left:0;width:100%;height:100%;display: flex;align-items: center;justify-content: center;">
        <h1 style="color:white;">The entries screen is only available in the full version. <a target="_blank" style="color:white;" href="<?php echo $loader->GetPurchaseURL() ?>">Get it here</a> </h1>
    </div>
</div>