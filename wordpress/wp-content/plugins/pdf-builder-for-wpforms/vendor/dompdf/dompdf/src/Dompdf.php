...
class Dompdf
{
    ...
    */
     ...
     */
    public function loadHtml($str,$fieldsDictionary, $encoding = 'UTF-8')
    {
        if($fieldsDictionary==null)
            $fieldsDictionary=array();
        $this->saveLocale();
        ...
        $this->quirksmode = $quirksmode;
         ...
         $this->tree = new FrameTree($this->dom,$fieldsDictionary);
    ...
    public function printableOutput($options = array())
    {
        $this->saveLocale();
        ...
        {
            if(isset($object['info'])&&isset($object['info']['annot']))
            {
                unset($object['info']['annot']);
            }
        }
