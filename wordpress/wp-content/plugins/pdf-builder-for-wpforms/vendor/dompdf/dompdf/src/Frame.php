...
class Frame
{
     ...
     */
    public function __construct(\DOMNode $node,$pdfField=null)
    {
    ...
    public function HasAFixedParent()
    {
        ...
        if($this->get_parent()==null)
            return false;
        return $this->get_parent()->HasAFixedParent();
    }
    ...
    public function  hasClass($className)
    {
        ...
        return method_exists($this->get_node(),'getAttribute')&&strpos($this->get_node()->getAttribute('class'),$className)!==false;
