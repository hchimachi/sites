...
class TemplateListAjax extends AjaxBase
{
    ...
    public function Export(){
        ...
        {
            echo "Sorry, the plugin could not generate a zip archive to export the template because the extension Zip Extension is not installed in your site. Please contact your hosting/server support and ask them to enable it for your site";
            return;
        }
